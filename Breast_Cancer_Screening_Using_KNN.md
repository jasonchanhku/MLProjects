...
<li>
Renderer: <a id="plot_id461400259_renderer_svg" class="ggvis-renderer-button" onclick="return false;" data-plot-id="plot_id461400259" data-renderer="svg">SVG</a> | <a id="plot_id461400259_renderer_canvas" class="ggvis-renderer-button" onclick="return false;" data-plot-id="plot_id461400259" data-renderer="canvas">Canvas</a>
</li>
<li>
<a id="plot_id461400259_download" class="ggvis-download" data-plot-id="plot_id461400259">Download</a>
</li>
</ul>
</nav>

<script type="text/javascript">
var plot_id461400259_spec = {
  "data": [
    {
      "name": ".0",
      "format": {
...
ggvis.getPlot("plot_id461400259").parseSpec(plot_id461400259_spec);
</script>
<!--/html_preserve-->
<br />
...
<ul class="ggvis-dropdown">
<li>
Renderer: <a id="plot_id380064581_renderer_svg" class="ggvis-renderer-button" onclick="return false;" data-plot-id="plot_id380064581" data-renderer="svg">SVG</a> | <a id="plot_id380064581_renderer_canvas" class="ggvis-renderer-button" onclick="return false;" data-plot-id="plot_id380064581" data-renderer="canvas">Canvas</a>
</li>
<li>
<a id="plot_id380064581_download" class="ggvis-download" data-plot-id="plot_id380064581">Download</a>
</li>
</ul>
</nav>

<script type="text/javascript">
var plot_id380064581_spec = {
  "data": [
    {
      "name": ".0",
      "format": {
...
ggvis.getPlot("plot_id380064581").parseSpec(plot_id380064581_spec);
</script>
<!--/html_preserve-->
Preliminary Insights
--------------------
